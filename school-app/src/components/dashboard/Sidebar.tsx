...
import { LucideIcon, Home, Users, BookOpen, Shield } from "lucide-react";
...
type UserRole = "ADMIN" | "PRINCIPAL" | "TEACHER" | "STUDENT" | "SUPER_ADMIN";
...
const links: SidebarLink[] = [
  {
    ...
    icon: Home,
    path: "/dashboard",
    roles: ["ADMIN", "PRINCIPAL", "TEACHER", "STUDENT", "SUPER_ADMIN"],
  },
  {
    label: "Users",
    icon: Users,
  ...
  },
  {
    ...
    roles: ["ADMIN", "PRINCIPAL", "TEACHER", "SUPER_ADMIN"],
  },
  {
    label: "SuperAdmin",
    icon: Shield,
    path: "/dasboard/superadmin",
    roles: ["SUPER_ADMIN"],
  },
];
