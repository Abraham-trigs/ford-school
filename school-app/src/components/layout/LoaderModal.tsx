...
export default function LoaderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
      <div className="flex flex-col items-center justify-centerrounded-lg p-6 shadow-lg">
        <h1 className="text-4xl font-thin text-lightGrey mb-6 animate-pulse">
          {text}
        </h1>
        <div className="relative w-16 h-16">
          <div className="absolute inset-0 rounded-full border-4 border-accentTeal border-t-transparent animate-spin"></div>
