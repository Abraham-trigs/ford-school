...
export default function ClassRepPage() {
  ...
  const [recordToEdit, setRecordToEdit] = useState<ClassRep | undefined>();
  const [deleteModalOpen, setDeleteModalOpen] = useState(false);
  const [recordToDelete, setRecordToDelete] = useState<ClassRep | null>(null);
