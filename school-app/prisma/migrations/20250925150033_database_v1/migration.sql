...
-- CreateEnum
CREATE TYPE "public"."PaymentType" AS ENUM ('DAILY', 'WEEKLY', 'MONTHLY', 'TERMLY', 'YEARLY', 'ONE_TIME');
...
-- CreateIndex
CREATE UNIQUE INDEX "AssessmentType_name_key" ON "public"."AssessmentType"("name");

-- CreateIndex
CREATE INDEX "Classwork_studentId_idx" ON "public"."Classwork"("studentId");

-- CreateIndex
CREATE INDEX "Classwork_teacherId_idx" ON "public"."Classwork"("teacherId");

-- CreateIndex
CREATE INDEX "Classwork_subjectId_idx" ON "public"."Classwork"("subjectId");

-- CreateIndex
CREATE INDEX "Classwork_typeId_idx" ON "public"."Classwork"("typeId");
...
-- CreateIndex
CREATE INDEX "SubjectAssignment_teacherId_idx" ON "public"."SubjectAssignment"("teacherId");

-- CreateIndex
CREATE INDEX "SubjectAssignment_subjectId_idx" ON "public"."SubjectAssignment"("subjectId");
...
-- AddForeignKey
ALTER TABLE "public"."Classwork" ADD CONSTRAINT "Classwork_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "public"."Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Classwork" ADD CONSTRAINT "Classwork_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Classwork" ADD CONSTRAINT "Classwork_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "public"."Subject"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Classwork" ADD CONSTRAINT "Classwork_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "public"."AssessmentType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."SubjectAssignment" ADD CONSTRAINT "SubjectAssignment_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
